...
import { GetAllUsersFromDatabase } from ".//..//..//actions/user";
...
import GetAllEmoji from ".//..//..//actions/emoji";
  ...
  return (
    <div className="container">
      ...
      <div className="container-1">
        ...
        />
        <button className="botton-emoji" onClick={() => setModalIsOpen(true)}>
          :)
        </button>
        <Modal
          className="modal"
          ...
          ariaHideApp={false}
        >
          <span className="close-emoji" onClick={() => setModalIsOpen(false)}>
            X
          </span>
          <br></br>
          {all.map((item) => (
